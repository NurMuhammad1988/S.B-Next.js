...
export const SearchCommand = () => {
    ...
    useEffect(() => {
        const down = (e: KeyboardEvent) => {
            if (e.key === "k" && (e.metaKey || e.ctrlKey)) {//citrl bilan k keyboardlar bosilganda shu search component ishga tushadi
                e.preventDefault();
                onToggle();
            }
        };
    ...
    const onSelect = (id: string) => {//yani onSelect function chaqirilgan CommandItem componentda search qilib chaqirilgan idli documentga bosilganda router userni shu document ichiga olib kiradi va onClose ishlaydi yani search component close qilinadi bu onClose use-search.ts componentda zustand bilan qilingan storeda turipti
