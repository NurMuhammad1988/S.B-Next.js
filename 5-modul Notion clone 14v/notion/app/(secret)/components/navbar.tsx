...
export const Navbar = ({ isCollapsed, reset }: NavbarProps) => {
    ...
    return (
        <>
            ...
            /////////////yani user trash iconga click qilganda isArchivedga tushgan documentlar chiqadi va shu documentlarga click qilinganda isArchived holati true bo'lgani uchun bu bannar.tsx navbar real user navbarida chiqadi// yani isArchivedni shu navbarda tekshirish kerak chunki banner shu navbarda chiqishi kerak
