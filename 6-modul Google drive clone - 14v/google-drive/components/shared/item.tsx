...
const Item = ({ icon: Icon, label, path }: ItemProps) => {
    return (
        <div className="flex items-center transition hover:bg-secondary rounded-full px-4 py-2 cursor-pointer">
            {/* bu holatda interface ichidagi icon  Item componentda  chaqirilgada  component qilindi yani endi bir vaqtni o'zida iconni component qilib chaqirib classlarham berib ketsa bo'ladi*/}
