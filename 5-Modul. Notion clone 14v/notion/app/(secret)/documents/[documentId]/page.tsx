...
interface DocumentIdPageProps {
    params: {
        ...
        //YANI FAIL BU DYNAMIC YARATILGAN YANI "ADD A PAGE" YOKIDA "NEW DOCUMENT" TEXTLARIGA BOSGANDA DYNAMIC YARATILADIGAN DOCUMENTLARNI RETURN ICHIDA JSX QIVOLISH YANI RETURNDA JSXDA RETURN QILISH
    };
}
