    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-x-2  ">
                {isLoading && <Loader />}
                {/* Loader bu holatda components va ichida loader2 iconi bor bunga components/ui/loader.tsxda cn bilan har hil varyant classlar berilgan kerak bo'lganda varyant bilan hohlagan stylesini chaqirib ishlatish mumkun masalan {isLoading && <Loader size={"xl"} />}>>> ///////////// yani agar isloading yani user aftorizatsadan o'tgan bo'lib isloading true bo'lsa Loader ishlaydi yani serverdan true degan javob kelgancha loader ishlab turadi */}
