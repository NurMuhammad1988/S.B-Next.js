...
const AuthLayout = ({ children }: ChildProps) => {
    return (
        <div className="relative">
            ...
            {/* user regist qilmagan vaqtda va lekin clerkdan userbutton kelib turgan vaqtda clerk button orqa qismini opacity bilan 50% hira qilib qo'yildi */}
            {/* z-indexlarga etiborli bo'l navbarda 30 dan boshlangan bu joyda esa 50 da tugagan yani maqsad bir birini ustiga novbat bilan chiqarish yani user kelgandan regist qilib saytga kirgancha bo'lgan holat z-index bilan to'g'irlangan */}
            <Navbar />
