            ...
            <section className="flex  flex-col space-y-12">
                ...
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                    {products.map((product) => (
                      // product kalit so'z yani parametr endi Product pagega props qilib jo'natilgan  product parametrda products o'zgaruvchi ichida serverdan kelgan hamma datalar bor bu datalarni   Product.tsx failida typi nima ekanligi aytilib distruptatsa qilib chaqirib ishlatish mumkun
